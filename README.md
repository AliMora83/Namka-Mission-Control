...
This is the **Mission Control hub** for all Namka projects. Keep it concise — the `Master.md` is the canonical source of truth for deep context, blockers, and per-project next steps.
